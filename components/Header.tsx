      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          <nav className="hidden lg:flex items-center space-x-8">
            ...
            <a href="tel:8778617547" className="text-slate-300 hover:text-orange-500 font-medium transition-colors">
              (877) 861-7547
            </a>
        ...
        {isMobileMenuOpen && (
          <div className="lg:hidden py-6 border-t border-slate-800">
            <nav className="flex flex-col space-y-4">
              ...
              <a href="tel:8778617547" className="text-slate-300 hover:text-orange-500 font-medium transition-colors py-2">
                (877) 861-7547
              </a>
